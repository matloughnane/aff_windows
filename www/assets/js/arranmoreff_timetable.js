...
function constructTable(timetableObj, season, journey){
    ...
    var tableHTML = "<table class='"+cssColor+" align-center' border='1'> <thead> <tr> <th class='"+cssColor+"' colspan='"+array_wd.length+"'>" + journey + "</th> </tr> <tr> <th class='"+cssColor+" subheading' colspan='"+array_wd.length+"'>"+weekday_message+"</th> </tr> </thead>";
    tableHTML += "<tbody> <tr>";
